...
const mockLogs = [
  { id: 1, user: 'Agent', action: 'Manual Payment', date: '2024-06-03', details: 'Payment for Chit Group A' },
  { id: 2, user: 'Agent', action: 'Attendance Punch', date: '2024-06-04', details: 'Punched In at 09:00' },
];
