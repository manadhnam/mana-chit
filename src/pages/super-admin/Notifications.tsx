...
const mockNotifications = [
  { id: 1, message: 'System maintenance scheduled', date: '2024-06-01', status: 'Delivered', channel: 'Email' },
  { id: 2, message: 'New chit group created', date: '2024-06-02', status: 'Pending', channel: 'Push' },
];
