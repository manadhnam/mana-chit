...
const mockLogs = [
  { id: 1, user: 'Admin', action: 'Approved KYC', date: '2024-06-01', details: 'KYC for Ravi Kumar' },
  { id: 2, user: 'Branch Manager', action: 'Assigned QR', date: '2024-06-02', details: 'QR to Agent 1' },
];
