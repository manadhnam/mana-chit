...
const mockNotifications = [
  { id: 1, message: 'Branch meeting at 5 PM', date: '2024-06-03', status: 'Delivered', channel: 'SMS' },
  { id: 2, message: 'New agent assigned', date: '2024-06-04', status: 'Pending', channel: 'Push' },
];

const Notifications = () => {
  const [notifications, setNotifications] = useState(mockNotifications);
  const [form, setForm] = useState({ message: '', channel: 'SMS' });
