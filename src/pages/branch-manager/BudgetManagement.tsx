...
import { CurrencyDollarIcon, ChartBarIcon, ClockIcon, ArrowTrendingUpIcon, ArrowTrendingDownIcon, PlusIcon } from '@heroicons/react/24/solid';
...
const BranchManagerBudgetManagement = () => {
    ...
    <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-1">
          Monitor and manage branch budget
        </p>
      </div>
...
export default BranchManagerBudgetManagement; 