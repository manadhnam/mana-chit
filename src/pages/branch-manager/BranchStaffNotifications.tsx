import {UserGroupIcon, BellIcon, DocumentTextIcon, ClockIcon} from '@heroicons/react/24/outline';
import { ChartBarIcon, BanknotesIcon, CheckCircleIcon, ExclamationTriangleIcon, XCircleIcon, InformationCircleIcon } from '@heroicons/react/24/solid';
...
const mockNotifications: Notification[] = [
  {
    ...
    message: 'Sarah Wilson has been added to the branch team.',
  ...
  },
  {
    ...
    message: 'Branch performance metrics are below target for this month.',
...
const BranchStaffNotifications: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Stay updated with important notifications from your branch</p>
      </div>
...
export default BranchStaffNotifications; 