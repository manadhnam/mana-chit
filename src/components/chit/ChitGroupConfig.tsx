...
const ChitGroupConfig: React.FC<ChitGroupConfigProps> = ({ onSave, onCancel }) => {
  ...
  // Form states
  const [rangeForm, setRangeForm] = useState<CreateRangeForm>({
    minAmount: 1000,
    maxAmount: 20000,
    stepAmount: 1000,
    commission: 5,
    ...
    eligibilityCriteria: {
      ...
      minIncome: 15000,
      minCreditScore: 600,
      requiredDocuments: ['Aadhar', 'PAN', 'Bank Statement'],
      employmentTypes: ['Salaried', 'Self-Employed', 'Business'],
      residenceTypes: ['Owned', 'Rented'],
      maxExistingLoans: 2,
      minBankBalance: 5000,
    },
    documents: ['Aadhar', 'PAN', 'Bank Statement', 'Income Proof'],
  });

  const [globalSettings, setGlobalSettings] = useState<GlobalChitSettings>({
  ...
  const [riskConfig, setRiskConfig] = useState<RiskAssessmentConfig>({
    lowRiskThreshold: 70,
    mediumRiskThreshold: 40,
    highRiskThreshold: 0,
    factors: [
      { id: '1', name: 'Age', weight: 10, description: 'Customer age factor', calculationMethod: 'RANGE', minValue: 18, maxValue: 65 },
      { id: '2', name: 'Income', weight: 25, description: 'Monthly income stability', calculationMethod: 'RANGE', minValue: 15000, maxValue: 100000 },
      { id: '3', name: 'Credit Score', weight: 20, description: 'Credit history score', calculationMethod: 'RANGE', minValue: 300, maxValue: 900 },
      { id: '4', name: 'Employment History', weight: 15, description: 'Years of employment', calculationMethod: 'RANGE', minValue: 0, maxValue: 30 },
      { id: '5', name: 'Existing Loans', weight: 15, description: 'Number of active loans', calculationMethod: 'RANGE', minValue: 0, maxValue: 5 },
      { id: '6', name: 'Bank Balance', weight: 15, description: 'Average bank balance', calculationMethod: 'RANGE', minValue: 0, maxValue: 100000 },
    ],
    scoringWeights: {
      age: 10,
      income: 25,
      ...
      const mockRanges: ChitGroupRange[] = [
        ...
        },
        {
          ...
          eligibilityCriteria: {
            ...
            minIncome: 20000,
            minCreditScore: 600,
            requiredDocuments: ['Aadhar', 'PAN', 'Income Proof'],
            employmentTypes: ['Salaried', 'Self-Employed', 'Business'],
            residenceTypes: ['Owned', 'Rented'],
            maxExistingLoans: 2,
            minBankBalance: 5000,
        ...
        },
        {
          ...
          eligibilityCriteria: {
            ...
            minIncome: 50000,
            minCreditScore: 700,
            requiredDocuments: ['Aadhar', 'PAN', 'Income Proof', 'Bank Statement', 'Property Documents'],
            employmentTypes: ['Salaried', 'Business'],
            residenceTypes: ['Owned'],
            maxExistingLoans: 1,
            minBankBalance: 10000,
          },
          documents: ['Aadhar', 'PAN', 'Bank Statement', 'Income Proof', 'Property Documents'],
          createdAt: new Date(),
          updatedAt: new Date(),
        },
      ];
      setRanges(mockRanges as ChitGroupRange[]);
    } catch (error) {
  ...
  const handleEditRange = (range: ChitGroupRange) => {
    ...
    setRangeForm({
      ...
      eligibilityCriteria: range.eligibilityCriteria,
...
export default ChitGroupConfig; 